...
def run_a_partition(partition, solver_opts, timeout, problem_path, partitioner):
    ...
    # Scramble the partition
    smt_partition = scramble_partitions(process_rank, problem_path)
...
# TODO: make project 6 the scrambling version
...
if my_rank == 0:
    ...
    while messages_received < number_of_partitions:
        ...
        if worker_result in ["sat"]:
            ...
            print("error occurred on a scramble")
